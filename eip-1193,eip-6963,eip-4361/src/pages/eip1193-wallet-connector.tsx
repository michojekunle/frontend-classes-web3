              ...
              <Tooltip.Root>
                <Tooltip.Trigger asChild>
                  <button className="inline-flex items-center">
                    ...
                    <span>
                      Securely connect and manage your Ethereum wallet
                    </span>
                  </button>
                </Tooltip.Trigger>
                <Tooltip.Portal>
                  <Tooltip.Content
                    ...
                    sideOffset={5}
                  >
                    Note: this implementation uses the latest wallet that
                    assigns its provider details to the `window.ethereum`
                    browser state.
